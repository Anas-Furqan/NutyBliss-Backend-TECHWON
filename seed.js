...
const seedData = async () => {
  try {
    ...
    const categories = await Category.insertMany([
      { name: 'Peanut Butter', slug: 'peanut-butter', description: 'Core Nuty Bliss peanut butter range' },
      { name: 'Oats', slug: 'oats', description: 'Breakfast oats and blends' },
      { name: 'Bundles', slug: 'bundles', description: 'Combo packs and value bundles' },
      { name: 'Accessories', slug: 'accessories', description: 'Store accessories and add-ons' },
    ]);
